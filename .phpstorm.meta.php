...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.available_locales.bn' => 'string',
            ...
            'filesystems.links./Users/raiyan/code/github/room-subscription/public/storage' => 'string',
            ...
            'laravel-subscriptions.tables.plans' => 'string',
            'laravel-subscriptions.tables.features' => 'string',
            'laravel-subscriptions.tables.subscriptions' => 'string',
            'laravel-subscriptions.tables.subscription_usage' => 'string',
            'laravel-subscriptions.models.plan' => 'string',
            'laravel-subscriptions.models.feature' => 'string',
            'laravel-subscriptions.models.subscription' => 'string',
            'laravel-subscriptions.models.subscription_usage' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.available_locales.en','app.available_locales.bn','auth.defaults.guard',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/raiyan/code/github/room-subscription/public/storage','inertia.ssr.enabled',
...
'inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','laravel-subscriptions.tables.plans',
'laravel-subscriptions.tables.features','laravel-subscriptions.tables.subscriptions','laravel-subscriptions.tables.subscription_usage','laravel-subscriptions.models.plan','laravel-subscriptions.models.feature',
'laravel-subscriptions.models.subscription','laravel-subscriptions.models.subscription_usage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.same_site','session.partitioned','sslcommerz.apiCredentials.store_id','sslcommerz.apiCredentials.store_password','sslcommerz.apiUrl.make_payment',
'sslcommerz.apiUrl.transaction_status','sslcommerz.apiUrl.order_validate','sslcommerz.apiUrl.refund_payment','sslcommerz.apiUrl.refund_status','sslcommerz.apiDomain',
...
'boost.executable_paths.vendor_bin','mcp.redirect_domains','reverb.default','reverb.servers.reverb.host','reverb.servers.reverb.port',
...
'reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_connections','reverb.apps.apps.0.max_message_size','reverb.apps.apps.0.accept_client_events_from','eloquent-sortable.order_column_name',
'eloquent-sortable.sort_when_creating','eloquent-sortable.ignore_timestamps','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'boost.browser-logs','login','register','locale.update','subscribe','subscribe.store',
'subscribe.success','subscribe.fail','subscribe.cancel','rooms.index',
'rooms.search','rooms.slots','logout','dashboard','requests.index',
'requests.show','requests.store','requests.cancel','notifications.index','notifications.visit',
'notifications.read','notifications.read-all','admin.users.index','admin.users.update-role','admin.requests.index',
'admin.requests.show','admin.requests.approve','admin.requests.reject','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'app','exampleEasycheckout','exampleHosted','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'validation.custom.attribute-name.rule-name','app.brand.name','app.common.language','app.common.english','app.common.bengali',
'app.common.loading','app.common.checking','app.common.submit','app.common.cancel','app.common.view',
'app.common.action','app.common.footer_rights','app.roles.superadmin','app.roles.cr','app.roles.authenticated',
'app.nav.dashboard','app.nav.rooms','app.nav.my_requests','app.nav.manage_users','app.nav.manage_requests',
'app.account.logout','app.mobile_nav.open','app.mobile_nav.title','app.mobile_nav.description','app.status.pending',
'app.status.approved','app.status.rejected','app.status.awaiting_review','app.status.rejected_system','app.status.pending_review',
'app.auth.sign_in','app.auth.signing_in','app.auth.create_account','app.auth.creating_account','app.auth.log_in',
'app.auth.welcome_back','app.auth.sign_in_subtitle','app.auth.credentials_hint','app.auth.already_have_account','app.auth.dont_have_account',
'app.auth.name','app.auth.email','app.auth.password','app.auth.password_confirmation','app.auth.remember_me',
'app.auth.email_placeholder','app.auth.password_placeholder','app.auth.create_your_account','app.auth.get_started','app.auth.register',
'app.auth.register_hint','app.auth.name_placeholder','app.auth.diu_email_hint','app.auth.password_create_placeholder','app.auth.confirm_password',
'app.auth.confirm_password_placeholder','app.dashboard.title','app.dashboard.subtitle_superadmin','app.dashboard.subtitle_cr','app.dashboard.subtitle_guest',
'app.dashboard.card_available_rooms','app.dashboard.card_available_rooms_desc','app.dashboard.card_total_rooms','app.dashboard.card_total_rooms_desc','app.dashboard.card_my_pending_requests',
'app.dashboard.card_my_pending_requests_desc','app.dashboard.card_my_approved_requests','app.dashboard.card_my_approved_requests_desc','app.dashboard.card_pending_approvals','app.dashboard.card_pending_approvals_desc',
'app.dashboard.card_total_users','app.dashboard.card_total_users_desc','app.dashboard.card_occupied_rooms','app.dashboard.card_occupied_rooms_desc','app.dashboard.card_maintenance_rooms',
'app.dashboard.card_maintenance_rooms_desc','app.dashboard.empty_cr','app.dashboard.empty_non_cr','app.dashboard.section_pending_queue_title','app.dashboard.section_pending_queue_desc',
'app.dashboard.section_role_access_title','app.dashboard.section_role_access_desc','app.dashboard.browse_rooms','app.dashboard.review_requests','app.dashboard.recent_title',
'app.dashboard.recent_desc','app.dashboard.recent_empty_title','app.dashboard.table_room','app.dashboard.table_schedule','app.dashboard.table_status',
'app.dashboard.table_reviewer','app.dashboard.pending_empty_title','app.dashboard.pending_empty_desc','app.dashboard.pending_room_label','app.dashboard.role_access_authenticated_desc',
'app.dashboard.role_access_cr_desc','app.dashboard.role_access_superadmin_desc','app.rooms.availability_load_error','app.rooms.search_hint','app.rooms.checking_availability',
'app.rooms.rooms_available','app.rooms.room_free','app.rooms.room_free_sign_in_cta','app.rooms.request_room_title','app.rooms.submit_request',
'app.rooms.submitting','app.rooms.sign_in','app.rooms.register','app.rooms.select_time_slot','app.rooms.choose_filters_title',
'app.rooms.choose_filters_desc','app.rooms.checking_title','app.rooms.checking_desc','app.rooms.no_rooms_title','app.rooms.no_rooms_desc',
'app.rooms.room_title','app.rooms.free_for','app.rooms.available_badge','app.rooms.booking_window','app.rooms.pending_requests',
'app.rooms.request_room','app.rooms.dialog_desc','app.rooms.field_date','app.rooms.field_room','app.rooms.field_time_slot',
'app.rooms.field_purpose','app.rooms.purpose_placeholder','app.requests.title','app.requests.subtitle','app.requests.tab_all',
'app.requests.tab_pending','app.requests.tab_approved','app.requests.tab_rejected','app.requests.total_requests','app.requests.empty_title',
'app.requests.empty_desc','app.requests.table_room','app.requests.table_schedule','app.requests.table_purpose','app.requests.table_status',
'app.requests.table_reviewer','app.requests.table_submitted','app.request_details.back_admin','app.request_details.back_user','app.request_details.title',
'app.request_details.reviewed_by','app.request_details.auto_expired','app.request_details.awaiting_review','app.request_details.approve','app.request_details.reject',
'app.request_details.cancel','app.request_details.subtitle','app.request_details.review_status','app.request_details.actions','app.request_details.approve_request',
'app.request_details.reject_request','app.request_details.cancel_request','app.request_details.already_reviewed','app.admin_users.title','app.admin_users.roles_title',
'app.admin_users.select_role','app.admin_requests.title','app.admin_requests.subtitle','app.admin_requests.queue_title','app.admin_requests.queue_desc',
'app.admin_requests.table_requester','app.admin_requests.table_room','app.admin_requests.table_schedule','app.admin_requests.table_purpose','app.admin_requests.table_status',
'app.admin_requests.table_reviewer','app.flash.room_request_submitted','app.flash.room_request_cancelled','app.flash.room_request_approved','app.flash.room_request_rejected',
'app.flash.role_already_set','app.flash.role_updated','app.validation.room_not_available','app.validation.time_slot_already_approved','app.validation.only_pending_can_be_approved',
'app.validation.select_90_min_slot','app.validation.time_slot_already_booked','app.validation.booking_date_future','app.notifications.new_request_title','app.notifications.new_request_message',
'app.notifications.approved_title','app.notifications.approved_message','app.notifications.rejected_title','app.notifications.rejected_message','app.notifications.updated_title',
'app.notifications.updated_message','app.notifications.role_changed_title','app.notifications.role_changed_message','app.notifications.modal_title','app.notifications.mark_all_read',
'app.notifications.unread_count','app.notifications.empty_title','app.notifications.empty_desc','app.theme.toggle','app.theme.light',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SSLCZ_STORE_ID','SSLCZ_STORE_PASSWORD',
'SSLCZ_TESTMODE',);
